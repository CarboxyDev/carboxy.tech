...
export const LearnMoreButton = () => {
  return (
    <Tooltip delayDuration={400}>
      ...
      <TooltipContent 
        side="bottom"
        className="border-primary-400/30 bg-gradient-to-br from-primary-900/90 to-primary-800/90 text-primary-100 shadow-lg backdrop-blur-sm"
      >
        <div className="flex items-center gap-2 px-1 py-0.5">
          <ArrowBigDownDash className="h-3 w-3" />
          <span className="text-sm font-medium">View my featured projects</span>
        </div>
      </TooltipContent>
    </Tooltip>
  );
...
export const AboutMeButton = () => {
  return (
    <Tooltip delayDuration={400}>
      ...
      <TooltipContent 
        side="bottom"
        className="border-zinc-500/30 bg-gradient-to-br from-zinc-800/90 to-zinc-900/90 text-zinc-100 shadow-lg backdrop-blur-sm"
      >
        <div className="flex items-center gap-2 px-1 py-0.5">
          <ArrowRight className="h-3 w-3" />
          <span className="text-sm font-medium">Discover my journey & skills</span>
        </div>
      </TooltipContent>
    </Tooltip>
  );
